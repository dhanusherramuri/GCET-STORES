...
// //         {
// //           serialNo: 1,
// //           itemDescription: 'Oscilloscopes',
// //           quantity: 5,
// //           unitPrice: 35000,
// //           totalPrice: 175000,
// //           deliveryRequired: '2024-04-20',
...
// //       ...indent,
// //       status: selectedIndents.includes(indent.id) ? 'accepted' : indent.status
// //     })));
// //     setSelectedIndents([]);
// //     // Here you would update MongoDB
// //   };

// //   const handleReject = () => {
// //     setIndents(prev => prev.map(indent => ({
// //       ...indent,
// //       status: selectedIndents.includes(indent.id) ? 'rejected' : indent.status
// //     })));
// //     setSelectedIndents([]);
// //     // Here you would update MongoDB
// //   };
...
// //           <h1 className="text-xl font-bold">Purchase Indent Review</h1>
// //           <button
...
// //               <tbody>
// //                 {indents.map((indent) => (
// //                   <tr key={indent.id} className="border-t">
...
// //                                   <td className="px-2 py-1">₹{item.totalPrice}</td>
// //                                 </tr>
// //                               ))}
// //                             </tbody>
// //                           </table>
...
// //                     </td>
// //                     <td className="px-4 py-2">
// //                       ₹{indent.items.reduce((sum, item) => sum + item.totalPrice, 0)}
// //                     </td>
// //                     <td className="px-4 py-2">
// //                       {indent.remarks}
// //                     </td>
...
// import { LogOut, Check, X, Indent } from 'lucide-react';
// import { useNavigate } from 'react-router-dom';
...
//     setIndents(prev => prev.map(indent => ({
//       ...indent,
//       status: selectedIndents.includes(indent._id) ? 'accepted' : indent.status
//     })));
//     setSelectedIndents([]);
//   };
...
//     setIndents(prev => prev.map(indent => ({
//       ...indent,
//       status: selectedIndents.includes(indent._id) ? 'rejected' : indent.status
//     })));
//     setSelectedIndents([]);
//   };
...
//   //     setIndents(prev => prev.map(indent => ({
//   //       ...indent,
//   //       status: selectedIndents.includes(indent._id) ? 'pending' : indent.status
//   //     })));
//   //     setSelectedIndents([]);
//   //   } catch (error) {
//   //     console.error('Error updating status:', error);
