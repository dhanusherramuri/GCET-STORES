...
//   const handleIssue = async (issueId: string) => {
//     try {
//       const response = await fetch('http://localhost:3001/department-issue', {
//         method: 'POST',
//         headers: {
...
//                           <button
//                             onClick={() => handleIssue(issue._id)}
//                             className="flex items-center space-x-1 bg-indigo-600 text-white px-3 py-1 rounded hover:bg-indigo-700"
//                           >
//                             <Send size={16} />
//                             <span>Issue</span>
//                           </button>
