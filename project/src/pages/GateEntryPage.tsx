...
//   const [formData, setFormData] = useState<GateEntry>({
//     entryId,
//     invoiceNumber: '',
//     supplierName: '',
//     itemName: '',
...
//     try {
//       const response = await axios.post('http://localhost:3001/gate-entry', formData);
//       console.log('Response:', response.data);
//       alert('Gate entry recorded successfully!');
//       // Reset form except entryId and timestamp
//       setFormData(prev => ({
//         ...prev,
//         invoiceNumber: '',
//         supplierName: '',
